...
.. card::
    ...
    **What You Will Learn**
    ...
    - **Design** efficient database schemas using ER diagrams and normalization.
...
- **Present**: Major releases annually; PostgreSQL 17 released September 2024.
...
2. Install the following extensions:
   ...
   - **SQLTools** — SQL editor and runner.
   - **PostgreSQL** (Chris Kolkman) — Syntax highlighting.
